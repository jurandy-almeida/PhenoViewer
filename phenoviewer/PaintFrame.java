...
public class PaintFrame extends JFrame
{
  ...
  public PaintFrame(BufferedImage original, BufferedImage maskor, boolean edit) {
    ...
    Action generateSquares = new AbstractAction("generateSquares") {
      public void actionPerformed(ActionEvent e) {
        paint.generateSquares();
      } };
    ...
    //squares
    JButton squaresButton = new JButton(generateSquares);
    buttonGroup.add(squaresButton);
    squaresButton.setText("Generate Squares");
    squaresButton.getActionMap().put("generateSquares", generateSquares);
